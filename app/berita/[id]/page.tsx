  ...
  return (
    <div className="py-10 sm:py-16 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
      ...
      <div className="mb-6">
        <Link
          href="/berita"
          className="inline-flex items-center gap-2 text-sm font-semibold text-brand-red hover:underline bg-red-50 px-4 py-2 rounded-xl transition"
        >
          <span>&larr;</span>
      ...
      <article className="bg-white rounded-3xl p-6 sm:p-10 shadow-lg border border-gray-100 relative">
        {/* Gambar Utama Artikel */}
        <div className="relative w-full h-64 sm:h-96 rounded-2xl overflow-hidden mb-6 bg-gray-100">
          <img
        ...
        <div className="flex items-center justify-between gap-3 mb-4 flex-wrap border-b border-gray-100 pb-4">
          <div className="flex items-center gap-2">
            <span className="text-xs font-semibold text-brand-red bg-red-50 px-3 py-1 rounded-md">
              {item.author || 'PW IPP'}
            </span>
        ...
        {/* Judul Artikel */}
        <h1 className="text-2xl sm:text-4xl font-extrabold text-brand-dark mb-6 leading-tight">
          {item.judul}
        </h1>
