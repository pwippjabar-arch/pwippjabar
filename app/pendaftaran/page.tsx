...
import { getPendaftaranData, PendaftaranItem } from '@/lib/api';
  ...
  return (
    <>
      <PageHeader
        ...
        description="Pilih agenda atau kegiatan PW IPP Jawa Barat yang sedang dibuka untuk melakukan pendaftaran."
      />
